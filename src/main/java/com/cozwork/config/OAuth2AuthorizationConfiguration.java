...
public class OAuth2AuthorizationConfiguration extends AuthorizationServerConfigurerAdapter {
    ...
    @Bean
    public org.springframework.security.oauth2.provider.OAuth2RequestFactory requestFactory() {
        OAuth2RequestFactory requestFactory = new com.cozwork.config.OAuth2RequestFactory(clientDetailsService);
    ...
    public JwtAccessTokenConverter jwtAccessTokenConverter() {
        ...
        converter.setKeyPair(new KeyStoreKeyFactory(new ClassPathResource("jwt.jks"), jwtSecretKey.toCharArray()).getKeyPair("jwt"));
        return converter;
    }
